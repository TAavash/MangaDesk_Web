        ...
        <div className="border-t border-gray-100 px-6 py-4 bg-white">
          <div className="flex items-center justify-center gap-8">
            <Button
              ...
              size="lg"
              onClick={() => setShowAddModal(true)}
              className="flex flex-col items-center gap-1 h-auto py-2 px-4 hover:bg-blue-50 group"
            >
              <FolderPlus className="w-6 h-6 text-blue-600 group-hover:scale-110 transition-transform" />
              <span className="text-xs text-gray-600 group-hover:text-blue-600">Add Folder</span>
            </Button>
            ...
            <Button
              ...
              size="lg"
              onClick={() => setIsEditing(!isEditing)}
              className="flex flex-col items-center gap-1 h-auto py-2 px-4 hover:bg-gray-50 group"
            >
              <Edit3 className="w-6 h-6 text-gray-600 group-hover:scale-110 transition-transform" />
